...
df$`Cod Istat` <- as.integer(df$`Cod Istat`)
        ...
        titletext <- "Data Source: Provinz <br /> Bozen Date : 12.4.2020,<br /> Created with: R by J. Mayr"
...
addLegend(pal = pal,title = "Positive in % zur EZ",na.label = "NA",position = "bottomright", values = ~dfc$Totali/ev*100, opacity = 1.0,
)%>%
