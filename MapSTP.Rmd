...
df$`Cod Istat` <- as.integer(df$`Cod Istat`)
        ...
        titletext <- "Data Source: Provinz  Bozen Date : 10.4.2020, Created with: R by J. Mayr"
...
addLegend(pal = pal,title = "Anzahl der Positiven in %",na.label = "Keine Angabe",position = "bottomright", values = ~dfc$Totali/ev*100, opacity = 1.0,
)%>%
