...
addLegend(pal = pal,title = "Quarantäne in % zur EZ",na.label = "Keine Angabe",position = "bottomright", values = ~dfc$quis/ev*100, opacity = 1.0)%>% addControl(titletext, position = "topright", className="map-title")
```