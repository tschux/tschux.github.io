...
addLegend(pal = pal,title = "Quarantäne in % zur EZ",labFormat = labelFormat(),na.label = "NA",position = "bottomright", values = ~dfc$quis/ev*100, opacity = 1.0)%>% addControl(titletext, position = "topright", className="map-title")
