...
addPolygons(stroke = F, smoothFactor = 0.3, fillOpacity = 0.7,
...
addLegend(pal = pal,title = "Positive in % zur EZ",na.label = "NA",position = "bottomright", values = ~dfc$Totali/ev*100, opacity = .7,
)%>%
